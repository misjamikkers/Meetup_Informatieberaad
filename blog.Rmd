...
Het doel van dit blog is om een toegankelijke inleiding te geven over causaliteit en data analyse. 
...
<!-- probleem met dit voorbeeld is dat als je het IQ van de ouder zou veranderen, door ze een lobotomie te geven b.v. het IQ van de kinderen niet zou veranderen. -->
...
Tenslotte is er een interventie $T$, het zogeheten "wondermiddel". Deze interventie is heel duur (en heeft daarom een invloed op de zorgkosten). Deze interventie heeft ondanks zijn hoge prijs, geen invloed op de ziektelast.
...
We hebben op op basis van deze DAG data gesimuleerd. Dat betekent dus dat er in onze data geen verband is tussen het wondermiddel ("Treatment") en de ziektelast.
...
Stel nu dat we dit niet weten, en we willen het causale effect van onze $Treatment$ op de $Ziektelast$ schatten. 

Dan blijkt uit de DAG dat de variabele $Zorgkosten$ een collider is, die we niet mee moeten nemen in de analyse.
...
We hebben onze data zo gesimuleerd dat er geen verband bestast tussen onze $Treatment$ en de $Ziektelast$. Het "goede model" schat het door ons bepaalde nul-effect. Het "verkeerde" model daarentegen laat ten onrechte zien dat onze $Treatment$ de $Ziektelast$ verlaagt.
...
Dit blog is geschreven naar aanleiding van een uitnodiging om een workshop te organiseren voor de 7de Meet Up van het Informatieberaad Zorg op 23 september 2019. Het publiek van deze Meet Ups is zeer divers: patiënten, zorgprofessionals, beleidsmakers én leveranciers en inkopers van technische oplossingen voor de zorg zijn bij deze Meet Ups aanwezig.
